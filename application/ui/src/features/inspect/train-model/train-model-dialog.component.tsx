    ...
    return (
        <Dialog size='L' UNSAFE_style={{ width: 'fit-content' }}>
                ...
                >
                    ...
                    >
                        <Suspense fallback={<Loading mode='inline' />}>
                            <TrainableModelListBox
                                selectedModelTemplateId={selectedModel}
                                onChangeSelectedTemplateId={(id) => id && setSelectedModel(id)}
            ...
            <ButtonGroup>
                ...
                <Button variant='accent' onPress={startTraining} autoFocus isPending={startTrainingMutation.isPending}>
                    Start
                </Button>
            </ButtonGroup>
        </Dialog>
